...
from gcloud_functions.shared.models.openweather_transformator import OpenWeatherDataIngestor
from gcloud_functions.shared.utils import DataConfigurator
